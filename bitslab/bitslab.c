...
/*
i * bitCount - returns count of number of 1's in word
...
unsigned float_neg(unsigned uf) {
 unsigned res;
 unsigned frac;
frac = uf & (0x7fffffff); //holds the fractional value
res = uf ^ 0x80000000;
if (frac > 0x7f800000)
 res =uf;
return res;
